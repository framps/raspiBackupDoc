...
Siehe dazu auch [Ist ein Backup eines laufenden Systems zuverlässig und sollte nicht das gesamte System vor dem Backup gestoppt werden](faq.md#1-ist-ein-backup-eines-laufenden-systems-zuverl%C3%A4ssig-sollte-nicht-das-gesamte-system-vor-dem-backup-gestoppt-werden)./
