...
https://framps.github.io/raspiBackupDoc/de/backup-options.html#--tarcompressiontool-definition-des-zu-nutzenden-tar-kompressionstools) statt mit der Option `-z` ein anderes Kompressionstool gewählt werden. 
