...
> You don't have to fiddle with the programming stuff.
> You have only to translate all messages into your native language.
> You even don't have to create a PR to get the new language into *raspiBackup*.
> All this programming stuff will be handled by *raspiBackup* developers for you.
